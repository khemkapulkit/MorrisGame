...
public class MiniMaxOpeningImproved
{
	...
	public static void main(String[] args)
	{
		...
		Output out= MiniMax(Integer.parseInt(args[2]), true, board);
	...
	{
		return (getNumPieces('W', board) + possibleMillsWhite(board) - getNumPieces('B', board));
	}
	...
	public static Output MiniMax(int depth, boolean isWhite, char[] board)
	{
